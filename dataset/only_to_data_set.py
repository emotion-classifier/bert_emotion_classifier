...
train_file = open("balanced_add_sad_half_neutral_train_data.csv", "w", encoding="utf-8")
test_file = open("balanced_add_sad_half_neutral_test_data.csv", 'w', encoding="utf-8")
...
for s in sentiment_list:
    if s is neutral:
        ...
        te_wr.writerows(s[int(len(s) / 2 * 0.9):int(len(s) / 2)])
    else:
