...
class LSTM_Model:
    def __init__(self):
        self.bert_path = 'C:\\Users\\kpc03\\Desktop\\졸업과제코드\\bert_model.ckpt'
    ...
    def training(self, epo, l2_norm=True, continue_training=False, first_training=False):
        ...
        save_path = 'C:\\Users\\kpc03\\Desktop\\졸업과제코드\\my_model'
    ...
    def evaluation(self):
        ...
        with tf.Session() as sess:
            model, bert_variables = self.create_model(self.X, self.X_mask)
            prediction = self.forward(model.get_pooled_output())
